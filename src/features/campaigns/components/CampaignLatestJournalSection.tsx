...
type CampaignLatestJournalSectionProps = {
  campaignId: string;
  loading: boolean;
  latestJournalEntry: CampaignJournalPreview | null;
};

const CampaignLatestJournalSection = ({
  campaignId,
  loading,
  latestJournalEntry,
}: CampaignLatestJournalSectionProps) => {
  return (
    <section className="rounded-xl border border-white/10 bg-zinc-900/35 p-3">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <i className="fa-solid fa-book-open text-xs text-zinc-500" />
...
export default CampaignLatestJournalSection;
