...
export const monsters: MonsterDefinition[] = [
  ...
  },
  {
    ...
    traits: [
      {
        name: "Damage Resistances",
        text: "Acid, cold, fire, necrotic, thunder; bludgeoning, piercing, and slashing from nonmagical attacks.",
      },
      {
        name: "Damage Immunities",
        text: "Lightning, poison.",
      },
      {
        name: "Condition Immunities",
        text: "Exhaustion, grappled, paralyzed, poisoned, prone, restrained, unconscious.",
      },
      {
        name: "Ephemeral",
      ...
      },
      {
        ...
        text: "The will-o'-wisp sheds bright light in a 5- to 20-foot radius and dim light for an additional number of feet equal to the chosen radius. It can alter the radius as a bonus action.",
      },
    ],
    actions: [
      {
        name: "Shock",
        text: "Melee Spell Attack: +4 to hit, reach 5 ft., one creature. Hit: 9 (2d8) lightning damage.",
      },
      {
        name: "Invisibility",
        text: "The will-o'-wisp and its light magically become invisible until it attacks, uses Consume Life, or ends the invisibility as a bonus action.",
      },
    ],
    bonusActions: [
      {
        name: "Consume Life",
        text: "The will-o'-wisp targets one creature it can see within 5 ft. that has 0 hit points and is still alive. The target must succeed on a DC 10 Constitution saving throw or die. If the target dies, the will-o'-wisp regains 10 (3d6) hit points.",
      },
    ],
  },
  {
    ...
    traits: [
      ...
      {
        name: "Damage Resistances",
        text: "Acid, cold, fire, lightning, thunder; bludgeoning, piercing, and slashing from nonmagical attacks.",
      },
      {
        name: "Damage Immunities",
        text: "Necrotic, poison.",
      },
      {
        name: "Condition Immunities",
        text: "Exhaustion, frightened, grappled, paralyzed, petrified, poisoned, prone, restrained.",
      },
      {
        name: "Amorphous",
    ...
    actions: [
      {
        name: "Strength Drain",
        text: "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 9 (2d6 + 2) necrotic damage, and the target's Strength score is reduced by 1d4. The target dies if this reduces its Strength to 0. The reduction lasts until the target finishes a short or long rest.",
      },
    ],
  },
  {
    ...
    actions: [
      ...
      {
        name: "Bite",
        text: "Melee Weapon Attack: +4 to hit, reach 5 ft., one creature. Hit: 6 (1d8 + 2) piercing damage plus 4 (1d8) poison damage. The target must succeed on a DC 11 Constitution saving throw or take the poison damage.",
      },
      {
        name: "Claws",
        text: "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 7 (2d4 + 2) slashing damage.",
      },
      {
        name: "Web (Recharge 5–6)",
  ...
  },
  {
    ...
    traits: [
      {
        name: "Damage Resistances",
        text: "Bludgeoning, piercing, and slashing from nonmagical attacks that aren't adamantine.",
      },
      {
        name: "Damage Immunities",
        text: "Poison.",
      ...
      {
        name: "Condition Immunities",
        text: "Exhaustion, petrified, poisoned.",
      },
      {
        name: "False Appearance",
        text: "While the gargoyle remains motionless, it is indistinguishable from an ordinary stone statue.",
      },
    ],
    actions: [
      {
  ...
  },
  {
    ...
    senses: "Darkvision 60 ft., passive Perception 10",
    language: "Understands all languages it knew in life but can't speak",
    challengeRating: "1",
    xp: 200,
    traits: [
      {
      ...
      {
        name: "Condition Immunities",
        text: "Charmed, exhaustion, grappled, paralyzed, petrified, poisoned, prone, restrained, unconscious.",
      },
      {
        name: "Incorporeal Movement",
  ...
  },
  {
    ...
    actions: [
      {
        name: "Beaks",
        text: "Melee Weapon Attack: +4 to hit, reach 5 ft., one target in the swarm's space. Hit: 7 (2d6) piercing damage, or 3 (1d6) piercing damage if the swarm has half of its hit points or fewer.",
      },
    ],
  },
];