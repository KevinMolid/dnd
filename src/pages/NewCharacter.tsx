...
const GuidedDndCharacterCreator = ({
  onBackToModeSelect,
}: {
        ...
        <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3">
          <section className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-xl sm:p-6 lg:col-span-2">
              ...
              <>
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  {[
                    ...
                    ["weight", "Weight", weight, setWeight],
                    ["eyes", "Eyes", eyes, setEyes],
                    ["skin", "Skin", skin, setSkin],
                    ["hair", "Hair", hair, setHair],
                ...
                <div className="mt-8 space-y-5">
                  ...
                  <div className="space-y-2">
                    <label
                      htmlFor="alliesAndOrganizations"
                      className="text-sm font-medium text-zinc-200"
                    >
                    ...
                    <textarea
                      ...
                      rows={4}
                      placeholder="Important allies, factions, guilds, families..."
                      className="w-full rounded-2xl border border-white/10 bg-zinc-900/80 px-4 py-3 text-sm text-white placeholder:text-zinc-500 outline-none transition focus:border-zinc-400"
                    />
                  </div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    {[
                      ...
                      ["ideals", "Ideals", ideals, setIdeals],
                      ["bonds", "Bonds", bonds, setBonds],
                      ["flaws", "Flaws", flaws, setFlaws],
                    ].map(([id, label, value, setter]) => (
                      <div key={id as string} className="space-y-2">
                        <label
                          htmlFor={id as string}
            ...
            <div className="mt-10 flex flex-col-reverse gap-3 border-t border-white/10 pt-6 sm:flex-row sm:justify-between">
              ...
              >
                {isFirstStep ? "Change character type" : "Back"}
              </button>
...
type CharacterCreationMode = "guided" | "custom";

const NewCharacter = () => {
  const navigate = useNavigate();

  const [creationMode, setCreationMode] =
    useState<CharacterCreationMode | null>(null);

  if (creationMode === "guided") {
    return (
      <GuidedDndCharacterCreator
        onBackToModeSelect={() => setCreationMode(null)}
      />
    );
  }
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base">
            Choose how you want to create this character.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <button
            ...
            className="group rounded-3xl border border-white/10 bg-white/5 p-6 text-left shadow-xl transition hover:border-white/20 hover:bg-white/[0.08] sm:p-7"
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <i className="fa-solid fa-arrow-right text-zinc-600 transition group-hover:translate-x-1 group-hover:text-white" />
            </div>
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-400">
              Build a D&amp;D 2024 character step by step using the ruleset,
              including class, species, background, equipment, spells, and
              rules-derived features.
            </p>

            <div className="mt-5 inline-flex rounded-full border border-white/10 bg-zinc-900/70 px-3 py-1.5 text-xs font-medium text-zinc-300">
              Rules-assisted
            </div>
          </button>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-amber-400/20 bg-amber-500/10 text-xl text-amber-300">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-400">
              Enter the character manually. Use this for homebrew characters,
              imported sheets, NPC-style characters, or anything that should not
              be constrained by the guided D&amp;D creator.
            </p>
